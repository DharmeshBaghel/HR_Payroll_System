...
* Real-time Analytics Dashboard: Uses Chart.js to translate repository datasets into intuitive administrative visualizations (Doughnut charts representing leave
  distribution and Bar charts showing headcount density across departments).
* 1-Click HR CSV Export: Instantly parses internal database state to generate structured CSV reports of personnel profiles, roles, salaries, and leave tracking
  balances.
* Sleek Slate/Midnight UI: Clean, ultra-professional glassmorphic interface featuring heavily blurred modern gradient backdrops, crisp grid layouts, minimal SVG SVG-Heroicons, and responsive design systems.
